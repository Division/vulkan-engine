...
void Game::init()
{
	...
	//lama_tex = loader::LoadTexture("assets/resources/lama.jpg");
	environment = loader::LoadTexture("assets/resources/environment/skybox.ktx");
	lama_tex = loader::LoadTexture("assets/resources/lama.ktx");
