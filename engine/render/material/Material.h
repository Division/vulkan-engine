...
public:
	...
	const std::shared_ptr<Texture>& Texture0() const { return texture0; };
	
	void NormalMap(std::shared_ptr<Texture> normal_map_);
	std::shared_ptr<Texture> NormalMap() const { return normal_map; };
