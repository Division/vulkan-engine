...
namespace scene
{
	...
	public:
		void Awake() override
		{
			...
			material->SetNormalMapResource(Resources::TextureResource::Linear(L"assets/Textures/ground/stilyzed/T_black_soil_normal.dds"));
			...
			material->AddExtraTexture(Resources::TextureResource::Linear(L"assets/Textures/ground/stilyzed/T_black_soil_cracks_normal.dds"), "normal1");
			...
			material->AddExtraTexture(Resources::TextureResource::Linear(L"assets/Textures/ground/stilyzed/T_ground_water_normal.dds"), "normal2");
			...
			material->AddExtraTexture(Resources::TextureResource::Linear(L"assets/Textures/ground/stilyzed/T_soil_water_normal.dds"), "normal3");
			material->AddExtraTexture(Resources::TextureResource::Linear(L"assets/top-down-shooter/ground/splatmap.dds"), "splatmap");
